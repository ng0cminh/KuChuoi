            ...
            <div className="main-menu">
                <div className="container">
                    <div className="nav-search">
                        ...
                        <div className={this.state.show ? "nav-overlay show" : "nav-overlay"} onClick={this.handlerShow}></div>
                        ...
                        <span className={this.state.isSearch ? "nav-search-close show" : "nav-search-close"} onClick={this.handleSearch}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                            </svg>
                        </span>
                        <span className={this.state.isSearch ? "nav-search-btn" : "nav-search-btn show"} onClick={this.handleSearch}>
